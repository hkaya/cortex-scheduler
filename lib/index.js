(function() {
  ...
  Scheduler = (function() {
    ...
    Scheduler.prototype._submit = function(view) {
      var ref, ref1;
      console.log(TAG + " New view to be submitted to slot " + view.slot + ". isVideo=" + view.isVideo + ", duration=" + view.duration + " file=" + view.file + ", label=" + ((ref = view.opts) != null ? (ref1 = ref.view) != null ? ref1.label : void 0 : void 0));
    ...
    Scheduler.prototype.onHealthCheck = function() {
      var now;
      ...
      if ((this._schedulerStartTime + HC_BLACKSCREEN_ACTIVATION_TIME < now) && (this._consecutiveBlackScreens > HC_BLACKSCREEN_THRESHOLD)) {
        return {
          status: false,
