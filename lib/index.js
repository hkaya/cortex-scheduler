(function() {
  var BLACK_SCREEN, BLACK_SCREEN_SLOT_NAME, CONTENT_DIV_ID, DEFAULT_VIEW, Scheduler, TAG;
  ...
  Scheduler = (function() {
    ...
    Scheduler.prototype._submit = function(view) {
      ...
      if (view.slot === this._defaultView) {
        nview = this._cloneView(view);
        nview.slot = DEFAULT_VIEW;
        this._submitDefaultView(nview);
      }
    ...
    Scheduler.prototype._renderVideoView = function(div, view, done) {
      return typeof this.onVideoView === "function" ? this.onVideoView(div, view.file, ((function(_this) {
        return function() {
          var ref;
          done(view.slot);
          _this._onViewEnd(view.slot);
      ...
      decrease = (function(_this) {
        return function() {
          ...
          if (opacity <= 0) {
            ...
            return (ref = _this.window) != null ? ref.requestAnimationFrame(decrease) : void 0;
          }
        };
      })(this);
      return decrease();
      ...
      increase = (function(_this) {
        return function() {
          ...
          if (opacity >= 1) {
            ...
            return (ref = _this.window) != null ? ref.requestAnimationFrame(increase) : void 0;
          }
        };
      })(this);
      return increase();
    ...
    Scheduler.prototype._cloneView = function(view) {
      var nview;
      nview = {
        slot: view.slot,
